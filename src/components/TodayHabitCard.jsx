  ...
  return (
    <div
      className={`card p-4 flex items-center gap-4 transition ${completed
        ? "ring-1 ring-teal-500/10 bg-teal-500/5 dark:bg-teal-500/3"
        : ""
        }`}
    >
      <div
      ...
      <div className="hidden sm:flex items-center gap-1 text-sm text-soft">
        <Flame
          size={16}
          className={streak > 0 ? "text-teal-600" : "text-faint"}
        />
      ...
      <button
        ...
        className={`shrink-0 w-11 h-11 rounded-full flex items-center justify-center transition ${completed
          ? "bg-gradient-to-br from-teal-500 to-teal-700 text-white shadow-lg shadow-teal-500/40 animate-pop"
          : "bg-teal-100 border-2 border-border-teal-400 text-teal-400 hover:border-teal-400 hover:text-teal-400"
          }`}
