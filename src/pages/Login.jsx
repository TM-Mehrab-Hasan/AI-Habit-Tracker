  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md">
        ...
        >
          <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-teal-500 to-teal-700 text-white flex items-center justify-center shadow-lg shadow-teal-500/30">
            <Sparkles size={18} />
          </div>
        ...
        <div className="card p-7">
          ...
          <div className="text-center mt-5 text-sm text-soft">
            ...
            <Link to="/register" className="text-teal-600 dark:text-teal-300 font-medium">
              Create one
            </Link>
          </div>
        </div>
