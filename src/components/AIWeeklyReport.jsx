...
export default function AIWeeklyReport() {
  ...
  const generate = async () => {
    ...
    try {
      ...
      setContent("Failed to generate the report. Please try again.");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="card p-5 relative overflow-hidden">
      ...
      >
        <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-teal-500 to-teal-700 text-white flex items-center justify-center shrink-0 shadow-lg shadow-teal-500/30">
          <Sparkles size={18} />
        </div>
