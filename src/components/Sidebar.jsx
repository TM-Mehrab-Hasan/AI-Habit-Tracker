    ...
    <aside className="hidden md:flex md:flex-col w-64 fixed inset-y-0 left-0 z-30 glass border-r">
      <div className="p-6 border-b divider">
        <div className="flex items-center gap-3">
          ...
          <div className="font-semibold text-lg tracking-tight">Health Tracker</div>
        </div>
      </div>
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition ${isActive
                ? "bg-gradient-to-r from-teal-500/15 to-teal-500/5 text-teal-700 dark:text-teal-300 ring-1 ring-teal-500/20"
      ...
      <div className="p-3 border-t divider space-y-1">
        ...
        <div className="px-2 py-2 flex items-center gap-3">
          <div className="w-9 h-9 rounded-full bg-gradient-to-br from-teal-500 to-teal-700 text-white font-semibold flex items-center justify-center shadow-md shadow-teal-500/30">
