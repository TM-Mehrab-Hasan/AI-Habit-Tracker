...
export default function AIChat() {
  ...
  return (
    <>
      <button
        onClick={() => setOpen((o) => !o)}
        className="fixed bottom-20 md:bottom-6 right-6 z-40 w-14 h-14 rounded-full bg-gradient-to-br from-teal-500 to-teal-700 text-white shadow-2xl shadow-teal-500/40 flex items-center justify-center hover:scale-105 active:scale-95 transition"
        aria-label="AI Chat"
      >
      ...
      {open && (
        <div className="fixed bottom-36 md:bottom-24 right-6 z-40 w-[min(92vw,380px)] h-[min(70vh,520px)] glass-strong rounded-2xl flex flex-col animate-slide-up shadow-2xl overflow-hidden">
          <div className="px-4 py-3 border-b divider flex items-center gap-2">
            <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-teal-500 to-teal-700 text-white flex items-center justify-center shadow-md shadow-teal-500/30">
              <Sparkles size={14} />
            </div>
            <div>
              ...
              >
                <div
                  className={`max-w-[85%] rounded-2xl px-3.5 py-2.5 text-sm leading-relaxed ${
                    m.role === "user"
                      ? "bg-gradient-to-br from-teal-500 to-teal-700 text-white rounded-br-md shadow-md shadow-teal-500/30"
                      : "glass rounded-bl-md"
                  }`}
                >
